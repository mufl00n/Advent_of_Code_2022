...
#     lines = fp.readlines()
#     for line in lines:
#         opponent, encoded_me = line.split()
#         me = element_mapping[encoded_me]
#         play = opponent + me
#         if play in wins:
#             points += 6 + element_scores[me]
#         elif opponent == me:
#             points += 3 + element_scores[me]
#         else:
#             points += 0 + element_scores[me]
#
# print(points)
